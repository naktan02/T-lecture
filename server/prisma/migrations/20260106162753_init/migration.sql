-- CreateEnum
CREATE TYPE "유형__t" AS ENUM ('Temporary', 'Confirmed');
...
-- CreateEnum
CREATE TYPE "군구분__t" AS ENUM ('Army', 'Navy', 'AirForce', 'Marines', 'MND');
...
CREATE TABLE "메시지" (
    ...
    "본문" TEXT,
    "상태" "상태__t",
    "생성일시" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "메시지_배정" (
    ...
    CONSTRAINT "메시지_배정_pkey" PRIMARY KEY ("dispatchId","unitScheduleId","userId")
);
...
CREATE TABLE "강사-부대 거리" (
    ...
    "이전거리" DECIMAL(65,30),
    "이전걸리는시간" INTEGER,
    "재계산필요" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "강사패널티" (
    "id" SERIAL NOT NULL,
    "강사id" INTEGER NOT NULL,
    "누적횟수" INTEGER NOT NULL DEFAULT 1,
    "만료일" TIMESTAMP(3) NOT NULL,
    "사유목록" JSONB,
    "생성일시" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "수정일시" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "강사패널티_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "강사" (
    ...
    "위도" DOUBLE PRECISION,
    "경도" DOUBLE PRECISION,
    "자차여부" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "instructor_stats" (
    ...
    "총근무시간" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "총이동거리" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "총근무일수" INTEGER NOT NULL DEFAULT 0,
    "수락건수" INTEGER NOT NULL DEFAULT 0,
    "총제안건수" INTEGER NOT NULL DEFAULT 0,
    "최근집계일시" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE INDEX "dispatch_user_idx" ON "메시지"("수신자id");
...
-- CreateIndex
CREATE INDEX "거리_재계산필요_idx" ON "강사-부대 거리"("재계산필요");
...
-- CreateIndex
CREATE UNIQUE INDEX "강사패널티_강사id_key" ON "강사패널티"("강사id");
...
-- AddForeignKey
ALTER TABLE "메시지" ADD CONSTRAINT "메시지_수신자id_fkey" FOREIGN KEY ("수신자id") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "메시지_배정" ADD CONSTRAINT "메시지_배정_dispatchId_fkey" FOREIGN KEY ("dispatchId") REFERENCES "메시지"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "메시지_배정" ADD CONSTRAINT "메시지_배정_unitScheduleId_userId_fkey" FOREIGN KEY ("unitScheduleId", "userId") REFERENCES "강사_부대_배정"("unitScheduleId", "userId") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "공지사항" ADD CONSTRAINT "공지사항_작성자id_fkey" FOREIGN KEY ("작성자id") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "문의사항" ADD CONSTRAINT "문의사항_작성자id_fkey" FOREIGN KEY ("작성자id") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "문의사항" ADD CONSTRAINT "문의사항_답변자id_fkey" FOREIGN KEY ("답변자id") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "강사_부대_배정" ADD CONSTRAINT "강사_부대_배정_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "강사_부대_배정" ADD CONSTRAINT "강사_부대_배정_unitScheduleId_fkey" FOREIGN KEY ("unitScheduleId") REFERENCES "부대일정"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "강사_부대_배정" ADD CONSTRAINT "강사_부대_배정_교육장id_fkey" FOREIGN KEY ("교육장id") REFERENCES "교육장소"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "강사패널티" ADD CONSTRAINT "강사패널티_강사id_fkey" FOREIGN KEY ("강사id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
