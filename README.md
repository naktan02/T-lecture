...
**교육 강사 배정 및 일정 관리 시스템**

교육 강사진의 배정, 스케줄링, 발송 업무를 자동화한 풀스택 웹 애플리케이션입니다.
...
- **관리자**: 강의장소 관리, 교육 일정 관리, 강사 배정, 대시보드 통계 확인
...
![Aiven](https://img.shields.io/badge/Aiven-FF3554?style=flat-square&logo=aiven&logoColor=white)
...
| **강의장소/강사 관리**     | Excel 일괄 업로드, 좌표 자동 변환                       |
...
- **Aiven** PostgreSQL 연결 안정성 확보
  - Keep-alive 메커니즘 적용으로 유휴 연결 유지
  - GitHub Actions 주기적 ping으로 DB 연결 상태 모니터링
  - Pool size 및 connection timeout 설정으로 안정성 확보
