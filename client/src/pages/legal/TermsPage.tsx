      ...
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-6 md:p-8">
        ...
        <div className="prose prose-sm max-w-none text-gray-700 space-y-6">
          ...
          <section>
            ...
            <p>
              본 약관은 푸른나무재단(이하 &ldquo;재단&rdquo;)이 운영하는 강사 배정 관리 시스템(이하
              &ldquo;서비스&rdquo;)의 이용과 관련하여 재단과 이용자 간의 권리, 의무 및 책임사항을
              규정함을 목적으로 합니다.
            </p>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>&ldquo;강사&rdquo;란 재단에 등록되어 인성교육을 수행하는 자를 말합니다.</li>
              <li>&ldquo;관리자&rdquo;란 재단 소속으로 서비스 운영 권한을 가진 자를 말합니다.</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>
                약관이 개정되는 경우 재단은 개정 내용과 시행일을 명시하여 서비스 내 공지사항을 통해
                시행일 7일 전부터 공지합니다.
              </li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>강사 회원의 경우, 관리자의 승인 절차를 거쳐 회원 자격이 부여됩니다.</li>
              <li>이용자는 가입 시 제공한 정보에 변경이 있는 경우 즉시 수정하여야 합니다.</li>
              <li>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>강사는 교육 수행 시 재단의 교육 지침과 품질 기준을 준수하여야 합니다.</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              <li>정당한 사유 없이 배정을 거절하는 경우 패널티가 누적됩니다.</li>
              <li>패널티가 누적되면 일정 기간 동안 배정 우선순위가 낮아질 수 있습니다.</li>
              <li>부대 사정으로 인한 배정 취소의 경우 강사에게 우선배정 크레딧이 부여됩니다.</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>탈퇴 시 이용자의 개인정보는 개인정보 처리방침에 따라 처리됩니다.</li>
              <li>진행 중인 배정이 있는 경우 해당 배정 완료 후 탈퇴가 처리될 수 있습니다.</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>재단은 이용자의 귀책사유로 인한 서비스 이용 장애에 대해 책임을 지지 않습니다.</li>
              <li>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              <li>본 약관에 명시되지 않은 사항은 관련 법령 및 재단의 정책에 따릅니다.</li>
              <li>
                서비스 이용과 관련하여 분쟁이 발생한 경우 재단의 소재지를 관할하는 법원을 전속관할로
                합니다.
              </li>
            </ol>
          </section>
          ...
          <div className="mt-8 flex justify-center">
            <button
              type="button"
              onClick={handleBack}
              className="flex items-center gap-2 px-6 py-3 bg-gray-100 hover:bg-gray-200 rounded-lg text-gray-700 font-medium transition-colors"
            >
