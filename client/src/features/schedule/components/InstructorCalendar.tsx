// src/features/schedule/components/InstructorCalendar.tsx
      ...
      <div className="w-full max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-end mb-6 border-b border-gray-200 pb-6 gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">날짜를 클릭하여 근무 일정을 등록하세요.</p>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="text-right hidden sm:block mr-2">
              ...
              <div className="font-bold text-2xl text-blue-600 leading-none">
                ...
                <span className="text-sm text-gray-400 ml-1 font-medium">days</span>
              </div>
            </div>
            <button
        ...
        <div className="shadow-sm rounded-xl overflow-hidden border border-gray-200">
          <Calendar
            ...
            tileClassName={({ date }: TileArgs): string | undefined => {
            ...
            next2Label={null}
            prev2Label={null}
            formatDay={(_locale: string | undefined, date: Date): string => format(date, 'd')}
