// client/src/features/unit/ui/UnitWorkspace.tsx
 ...
 * 모든 부대 관련 UI와 로직을 조합
 */
export const UnitWorkspace = (): ReactElement => {
  // 검색 파라미터
  ...
  const tutorialImages = Array.from({ length: 5 }, (_, i) => `/images/tutorial/unit/${i + 1}.png`);
